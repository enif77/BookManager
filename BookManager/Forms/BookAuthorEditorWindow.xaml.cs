...
namespace BookManager.Forms
{
    ...
    /// <summary>
    /// Interaction logic for BookAuthorEditorWindow.xaml
    /// </summary>
    public partial class BookAuthorEditorWindow : Window
    {
        #region properties
        ...
        {
            get { return DataContext as BookAuthor; }
        }
        ...
        private bool SaveClick()
        {
            try
            {
                ((BookAuthor)DataContext).Validate();
            }
            catch (Exception ex)
            {
