...
namespace BookManager.Forms
{
    ...
    /// <summary>
    /// Interaction logic for BookCategoryEditorWindow.xaml
    /// </summary>
    public partial class BookCategoryEditorWindow : Window
    {
        #region properties
        ...
        {
            get { return DataContext as BookCategory; }
        }
        ...
        public BookCategoryEditorWindow()
        {
            InitializeComponent();
        ...
        private bool SaveClick()
        {
            try
            {
                ((BookCategory)DataContext).Validate();
            }
            catch (Exception ex)
            {
