...
namespace BookManagerWF.Forms
{
    ...
    public partial class BookGenreEditorForm : Form
    {
        #region properties
        ...
        public static bool Open(BookGenre dataObject)
        {
            ...
            var dialog = new BookGenreEditorForm()
            {
                ...
                Text = (dataObject.Id <= 0)
                    ...
                    : String.Format("Book Manager - Book Type Genre {0}", dataObject.Id)
            };
