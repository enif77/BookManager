...
namespace BookManager.Forms
{
    ...
    /// <summary>
    /// Interaction logic for BookGenreEditorWindow.xaml
    /// </summary>
    public partial class BookGenreEditorWindow : Window
    {
        #region properties
        ...
        public BookGenre DataObject
        {
            get { return DataContext as BookGenre; }
        }
        ...
        private bool SaveClick()
        {
            try
            {
                ((BookGenre)DataContext).Validate();
            }
            catch (Exception ex)
            {
